  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="relative">
        ...
        <p className="text-white text-[16px] font-normal absolute z-[3] whitespace-pre-line leading-[18px] custom-shadow2 left-[25px] top-[355px]">
      ...
      <span className="text-[18px] leading-[120%] whitespace-pre-line">
        ...
        добычи природного газа, газопереработки и газохимии.{"\n"}Новая и
        возобновляемая энергетика.{"\n"}Промышленные объекты модульного
        исполнения.
      </span>
    </div>
  );
