    ...
    <>
      ...
      <div className="flex flex-col w-full">
        ...
        <p className="text-[18px] leading-[120%] whitespace-pre-line mt-[calc(335px+75px)]">
          Компания SSC Solutions (SSC) родилась в результате разговора за
          ужином. Мы с единомышленниками обсуждали возможность создания
          Компании, где каждый мог бы поделиться своим опытом и знаниями, помочь
          выстроить систему, при которой обеспечиваются высокие стандарты,
          ориентированные на Заказчика. Именно это привело к основанию SSC в
          2022 году.
          {"\n\n"}
